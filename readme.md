...
A companion web-based viewer for VinciMap Gaussian Splatting outputs is available here:

**[VinciMap Visualizer](https://github.com/ZotacD/vincimap-visualizer)**

It allows `.ply` reconstructions generated by VinciMap to be visualized, inspected, edited and measured directly in the browser.
