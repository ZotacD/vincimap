...
def create_workspace_configs(
    ...
    configs = [
        ...
        (
            ...
            configs_path / "colmap" / "image_undistorter.ini",
            None,
            {
                "image_path": project_relative_path(images_path),
                "input_path": project_relative_path(sparse_path / "0"),
                "output_path": project_relative_path(dense_path),
            },
        ),
    ]
